...
let greeting=`Hello, My name is ${firstName}, and ${age} years old`
console.log(greeting);
// Kiểm tra trong biến greeting có tồn tại từ "Hello" hay không, không phân biệt chữ hoa chữ thường, in ra kết quả
console.log("Tồn tại hello",greeting.toLowerCase().includes("Hello".toLowerCase()))
...
*/
let drivingAge= prompt("Mời bạn nhập tuổi")
if(drivingAge>=18){
    console.log("Bạn đã đủ tuổi lái xe");
}
else{
    console.log("ban chưa đủ tuổi");
}
/*
